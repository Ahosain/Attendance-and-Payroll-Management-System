...
public class TeacherAttendance extends javax.swing.JFrame {
    ...
    public ArrayList<TeacherStatus> UserList(){
        ArrayList<TeacherStatus> UserList = new ArrayList();
        try {
            String sql = "select * from teacherstatus";
            Statement st = (Statement) conn.createStatement();
            ResultSet rs = st.executeQuery(sql);
            
            TeacherStatus teacherStatus;
            while(rs.next()){
                teacherStatus = new TeacherStatus(rs.getString("teacherid"),rs.getString("name"),rs.getBoolean("status"));
                UserList.add(teacherStatus);
            }
    ...
    public void ShowTable(){
        ArrayList<TeacherStatus> list = UserList();
